...
typedef struct fpta_estimate_item {
  ...
  fpta_value range_from,
      range_to /* Задают диапазон оцениваемой выборки по значению опорной
                  колонки. При необходимости могут быть заданы значения с
                  псевдо-типами fpta_begin и fpta_end. При равенстве значений
                  range_from и range_to будет возвращено количество строк,
                  у которых значение соответствующей колонке равно искомым. */
      ;
