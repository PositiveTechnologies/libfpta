 ...
 *
 * Курсор должен быть открыт по колонке/индексу с контролем уникальности.
 * В противном случае функция возвратит FPTA_EINVAL, так как будет невозможно
 * однозначно восстановить позицию курсора.
 *
