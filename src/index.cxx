...
template <typename T>
static int __hot fpta_idxcmp_type(const MDBX_val *a,
                                  const MDBX_val *b) noexcept {
...
static int __hot fpta_idxcmp_fp32(const MDBX_val *a,
                                  const MDBX_val *b) noexcept {
...
static int __hot fpta_idxcmp_fp64(const MDBX_val *a,
                                  const MDBX_val *b) noexcept {
